...
html_legend <- "<img src='https://github.com/jeremyash/icons/blob/main/redFlame.png?raw=true'style='width:13px;height:15px;'>&nbsp;Burn&nbsp;location<br/>
...
air_mon_leaflet <- 
  ...
  addMarkers(data = burn_loc, lng = ~lon, lat = ~lat,
             icon = list(
               iconUrl = "https://github.com/jeremyash/icons/blob/main/redFlame.png?raw=true",
...
## Data Sources
AQI: EPA data accessed via https://cran.r-project.org/web/packages/AirMonitor/index.html
